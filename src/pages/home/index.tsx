        ...
        <div className="home">
            ...
            <form className="post-form">
                ...
                <div className='post-form__submit-area'>
                    ...
                    <input className='hidden' type="file" name="file-input" accept="image/*" onChange={handleFileUpload}></input>
                        ...
                        <Link to={`/posts/${post?.id}`}>
                            <div className="post__box-profile">
                                <div className="post__flex">
                                    {post?.profileUrl ? (<img />) : <FaUserCircle className='post__box-profile-icon'/>}
